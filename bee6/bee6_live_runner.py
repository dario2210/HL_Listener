...
bee6_live_runner.py
====================
Paper/live runner for the first BEE6 WaveTrend strategy.
...
from bee6_data import prepare_indicators
...
STATE_FILE = "bee6_live_state.json"
TRADES_LOG = "bee6_live_trades.jsonl"
LOG_FILE = "bee6_live_runner.log"
LOOP_SLEEP_SEC = 60
...
log = logging.getLogger("bee6_live")
...
def main_loop(mode: str = "paper") -> None:
    log.info(
        f"=== BEE6 live runner START | mode={mode} | "
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="BEE6 WaveTrend live/paper runner")
