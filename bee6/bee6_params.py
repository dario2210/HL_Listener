...
bee6_params.py
===============
Central configuration for the first BEE6 WaveTrend strategy.

Project structure stays aligned with bee1 on purpose, but the trading logic
and WFO grids are built around the BEE6 H1 long-only WaveTrend rules.
"""
...
WT_LONG_ENTRY_MAX_ABOVE_ZERO_GRID = [-10.0, -15.0, -20.0, -25.0]
WT_LONG_ENTRY_MAX_ABOVE_ZERO_OPTIONS = [-10.0, -15.0, -20.0, -25.0]
WT_LONG_CLOSE_MIN_LEVEL_GRID = [30.0, 40.0, 45.0, 50.0]
WT_LONG_CLOSE_MIN_LEVEL_OPTIONS = [30.0, 40.0, 45.0, 50.0]
...
WT_H4_LONG_FILTER_MAX_OPTIONS = [0.0]
WT_H4_LONG_CLOSE_MIN_GRID = [0.0]
WT_H4_LONG_CLOSE_MIN_OPTIONS = [0.0]
WT_H4_SHORT_FILTER_MIN_GRID = [30.0, 40.0, 50.0, 60.0]
WT_H4_SHORT_FILTER_MIN_OPTIONS = [30.0, 40.0, 50.0, 60.0]
WT_LONG_EMERGENCY_SL_CAPITAL_PCT_GRID = [0.0]
WT_LONG_EMERGENCY_SL_CAPITAL_PCT_OPTIONS = [0.0]
...
def load_params() -> dict:
    ...
    # BEE6 is temporarily long-only. Keep this enforced even when older WFO
    ...
    params["wt_long_entry_window_bars"] = 1
    params["wt_short_entry_window_bars"] = 1
    params["wt_long_require_ema20_reclaim"] = False
    params["wt_long_require_htf_trend"] = False
    params["wt_long_tp1_enabled"] = False
    params["wt_long_tp1_fraction"] = 0.0
    params["wt_long_tp1_breakeven_enabled"] = False
    params["wt_long_tp2_enabled"] = False
    params["wt_long_tp2_fraction"] = 0.0
    params["wt_short_tp1_enabled"] = False
    params["wt_short_tp1_fraction"] = 0.0
    params["wt_disable_partial_exits"] = True
    params["wt_long_breakeven_enabled"] = bool(
        params.get("wt_long_breakeven_enabled", WT_LONG_BREAKEVEN_ENABLED)
    )
